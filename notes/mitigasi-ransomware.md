...
### Edukasi Keamanan Siber (_Cyber Security Education_)
...
### Manajemen Data (_Data Management_)
...
### Kebijakan dan Manajemen Konfigurasi (_Policy and Configuration Management_)
...
### Pemeliharaan dan Perbaikan (_Maintenance and Repair_)
...
### Solusi Keamanan Teknis (_Technical Security Solutions_)
...
### Deteksi Aktivitas Anomali dan Pemahaman Dampak (_Anomalous Activity Detection and Impact Understanding_)
...
### Eksekusi Respons terhadap Insiden Terdeteksi (_Response Execution to Detected Incidents_)
...
### Analisis Efektif untuk Respons dan Pemulihan (_Effective Analysis for Response and Recovery_)
...
### Mitigasi Penahanan Peristiwa, dan Resolusi (_Event Containment Mitigation, and Resolution_)
...
### Peningkatan Respons Melalui Pembelajaran (_Response Improvement Through Lessons Learned_)
...
### Eksekusi dan Pemeliharaan Proses Pemulihan (_Recovery Process Execution and Maintenance_)
